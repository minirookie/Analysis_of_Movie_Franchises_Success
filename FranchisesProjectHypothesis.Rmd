...
#cat('\n!["Movie number compare"](paste(working.path,"barplot_MovieNumberComparison.png", sep = "/"))\n')
...
table(franmovie.regrset$actor_2_name)[1:50]
table(franmovie.regrset$actor_1_name)[1:50]
table(franmovie.regrset$actor_3_name)[1:50]
